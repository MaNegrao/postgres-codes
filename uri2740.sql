select 'Podium: ' || team as name from league where position = 1 or position = 2 or position = 3 union all select 'Demoted: ' || team as name from league where position = 14 or position = 15;
